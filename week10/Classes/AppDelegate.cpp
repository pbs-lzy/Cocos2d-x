...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	char diamond_totalFrames = 7;
	char diamond_frameName[20];
	Animation* diamondAnimation = Animation::create();
	for (int i = 0; i < diamond_totalFrames; i++)
	{
		sprintf(diamond_frameName, "diamond-%d.png", i);
		diamondAnimation->addSpriteFrame(SpriteFrameCache::getInstance()->getSpriteFrameByName(diamond_frameName));
	}
	//	帧间隔0.1秒，共三帧
